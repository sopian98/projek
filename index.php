...
float: right;
font-size: 16px;"> Last access : 30 May 2020 &nbsp; <a href="logout.php" class="btn btn-danger square-btn-adjust">Logout</a> </div>
        </nav>   
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <li><a href="?page=anggota"><i class="fa fa-users"></i> data anggota</a></li>
                    <li><a href="?page=buku"><i class="fa fa-book"></i> data buku</a></li>
                    <li><a href="?page=transaksi"><i class="glyphicon glyphicon-th-list"></i> transaksi </a></li>
